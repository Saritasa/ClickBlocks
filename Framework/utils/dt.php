...
class DT extends \DateTime
{
  ...
  {
    return (new DT('now'))->format($format, $timezone);
  }
  ...
  {
    return (new DT('tomorrow'))->format($format, $timezone);
  }
  ...
  {
    return (new DT('yesterday'))->format($format, $timezone);
  }
   ...
   *
   * @param string | \DateTimeInterface $date - string representing the date or a \DateTimeInterface object.
   * @param string $format - date format string.
  ...
  /**
   * Sets the time zone for the ClickBlocks\Utils\DT object.
  ...
  /**
   * Adds an amount of days, months, years, hours, minutes and seconds to a ClickBlocks\Utils\DT object.
   * Returns the DT object for method chaining or FALSE on failure.
   *
  ...
  /**
   * Subtracts an amount of days, months, years, hours, minutes and seconds from a ClickBlocks\Utils\DT object.
   * Returns the DT object for method chaining or FALSE on failure.
   *
   * @param string | \DateInterval - a \DateInterval object or interval string.
   * @return self
  ...
  /**
   * Adds an amount of days to a ClickBlocks\Utils\DT object. The amount of days can be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
   * @param integer $day
   * @return self
  ...
  /**
   * Adds an amount of months to a ClickBlocks\Utils\DT object. The amount of months can as well be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
   * @param integer $month
   * @return self
  ...
  /**
   * Adds an amount of years to a ClickBlocks\Utils\DT object. The amount of years might as well be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
   * @param integer $year
   * @return self
  ...
  /**
   * Adds an amount of hours to a ClickBlocks\Utils\DT object. The amount of hours might as well be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
   * @param integer $hour
   * @return self
  ...
  /**
   * Adds an amount of minutes to a ClickBlocks\Utils\DT object. The amount of minutes  might as well be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
  ...
  /**
   * Adds an amount of seconds to a ClickBlocks\Utils\DT object. The amount of seconds might as well be negative.
   * Returns the DT object for method chaining or FALSE on failure.
   *
  ...
  /**
   * Returns the difference between two ClickBlocks\Utils\DT objects.
   * Returns the DT object for method chaining or FALSE on failure.
   *

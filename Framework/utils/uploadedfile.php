...
class UploadedFile
{
  ...
  /**
   * Returns temporary path where originally uploaded file is stored.
   *
   * @return string
   * @access public
   */
   ...
   * @access public
   */
  public function getClientName($withoutExt = false)
  {
    if ($withoutExt) {
        return pathinfo($this->data['name'], PATHINFO_FILENAME);
    }
    else {

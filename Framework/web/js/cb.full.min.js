...
var Control = (function(undefined)
{
  ...
  Control.prototype.vs = function(ignore)
  {
    ...
    var res = {attrs: {}};
    if (this.el.get(0) && this.el.get(0)['value'] != undefined) res['value'] = this.value();
  ...
  POM.prototype.get = function(id, context)
  {
    ...
    if (el.length == 0)
    {
      if (!context)
      {
        ...
        {
          if (controls[cid].el.attr('data-fullid') && controls[cid].el.attr('data-fullid').substr(-id.length) == id) return controls[cid];
        }
      }
...
{
  ImageControl.superclass.constructor.call(this, el, pom);
};

...
class Panel extends Control implements \IteratorAggregate, \Countable
{
   ...
   *
   * @return \ClickBlocks\Web\POM\Iterator
   * @access public
   */
   ...
   *
   * @param \ClickBlocks\Web\POM\Control $ctrl - any control to be added to the panel.
   ...
   * @param \ClickBlocks\Web\POM\Control $new - the control to replace.
   * @return self
   * @access public   
   */
   ...
   * @return boolean|\ClickBlocks\Web\POM\Control
   * @access public
   */
